...
echo ██████╔╝██║██████╔╝██████╔╝   ██║          ██║   ╚██████╔╝╚██████╔╝███████╗
echo ╚═════╝ ╚═╝╚═════╝ ╚═════╝    ╚═╝          ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝  
echo A batch script coded by Cooper
echo.
echo ===========================================================================================================
echo Hello %username%!
echo.
...
if %Home%==listplugins goto pluginlist
...
:pluginload
start plugins\activated\%Home%.bat
goto home


:randnum
title Cooper's Multitool - Generating a random number
cls
echo %random%
...
:servertest
cls
title Cooper's Multitool - Checking a server's status
...
echo github.com/CooperMakesStuff/batch-multitool
ping %page%>nul
cls
if errorlevel 1 (
...
:cancel
cls
title Cooper's Multitool - Exiting...
echo Bye!
...
:note
cls
title Cooper's Multitool - Making a note
...
:wifitest
cls
title Cooper's Multitool - Testing internet connection
...
:kill
cls
title Cooper's Multitool - Shutting down computers on a LAN network
...
:users
cls
title Cooper's Multitool - Checking user info
net user
...
:history
cls
title Cooper's Multitool - Checking command history
...
:info
cls
title Cooper's Multitool - Showing version info
echo Multitool v4.0
echo.
echo Changelog:
...
:secretcmds
title Cooper's Multitool  - Secret stuff
cls
color 0a
echo.
echo ███╗   ███╗██╗   ██╗██╗  ████████╗██╗████████╗ ██████╗  ██████╗ ██╗     
...
:: find me on github!
:: github.com/CooperMakesStuff

:: find this work on github!
:: github.com/CooperMakesStuff/batch-multitool
